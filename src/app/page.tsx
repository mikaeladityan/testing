	...
	return (
		<div className="min-h-screen bg-gray-50">
			<main className="container mx-auto px-4 py-8">
				<h1 className="text-3xl font-bold text-center mb-8">Pengumpulan Data Pengguna</h1>
				...
				{!permissionsGranted ? (
					...
					<div className="bg-white rounded-lg shadow-md p-6 max-w-md mx-auto">
						<h2 className="text-xl font-semibold mb-6">Rekam Video</h2>
						<VideoRecorder userData={userData} />

						{userData && (
							<div className="mt-8 pt-6 border-t">
								<h3 className="font-medium mb-2">Data yang terkumpul:</h3>
								<pre className="text-xs bg-gray-100 p-3 rounded overflow-auto">{JSON.stringify(userData, null, 2)}</pre>
							</div>
						)}
					</div>
				)}
